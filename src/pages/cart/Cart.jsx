    ...
    <Layout>
      ...
      >
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
              ...
              return (
                ...
                >
                  ...
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                    ...
                    >
                      <h2
                        className="text-lg font-bold text-gray-900 sm:w-72"
                        style={{ color: mode === "dark" ? "white" : "" }}
                      >
                        {item.title}
                      </h2>
                      <h2
                        className="text-sm text-gray-900 line-clamp-3 sm:w-72 my-2"
                        style={{ color: mode === "dark" ? "white" : "" }}
                      >
                        {item.description}
                      </h2>
          ...
          <div
            className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3 sticky top-32"
            style={{
              backgroundColor: mode === "dark" ? "rgb(32 33 34)" : "",
              color: mode === "dark" ? "white" : "",
            }}
