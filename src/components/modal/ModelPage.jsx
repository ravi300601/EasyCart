...
function Page2({
  ...
  return (
    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
      ...
      <h3 className="text-lg font-semibold mb-2 text-center">Payment Method</h3>
      ...
      <form className="space-y-4 md:space-y-6" action="#">
        <div className="flex items-center mb-2">
          ...
          />
          <label for="checking" className="text-gray-700">
            RazorPay
          </label>
          <div className="ml-2">
            <p className="text-sm text-gray-500">
              Cards, Wallets, Banks & more
            </p>
          </div>
          <input
            type="radio"
            ...
            name="payment"
            className="ms-auto border-gray-300 text-indigo-600 focus:ring-blue-500 focus:border-blue-500"
        ...
        <div className="flex items-center mb-2">
          ...
          />
          <label for="savings" className="text-gray-700">
            Google Pay
          </label>
          <div className="ml-2">
            <p className="text-sm text-gray-500">UPI App</p>
          </div>
          <input
            type="radio"
            id="gpay"
            ...
            value="gpay"
            onChange={(e) => setPaymentMethod(e.target.value)}
            className="ms-auto border-gray-300 text-indigo-600 focus:ring-blue-500 focus:border-blue-500 rounded-full"
          />
        </div>
        <hr className="py-1" />
        <div className="flex items-center">
          ...
          <label for="mastercard" className="text-gray-700">
            Cash on Delivery
          </label>
          <div className="ml-2">
