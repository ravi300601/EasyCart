  ...
  return (
    <div className="bg-white sticky top-0 z-50">
      ...
      <header className="relative bg-white">
        <p
          className="flex h-10 items-center justify-center bg-sky-500 px-4 text-sm font-medium text-white sm:px-6 lg:px-8"
          style={{
        ...
        <nav
          aria-label="Top"
          className="bg-sky-50 px-4 sm:px-6 lg:px-8 shadow-xl "
          style={{
